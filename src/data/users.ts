...
export const usersSeed: User[] = [
  {
    ...
    verification: {
      status: 'Verified',
      badge: 'Verified to Meet',
      provider: 'Yoti',
      method: 'Government ID + Selfie',
      ageRequirement: '18+ confirmed',
      verifiedAt: 'Mar 18, 2024 · 14:32',
      reference: 'VRF-2024-0318-EL41',
      attempts: 1,
      checks: { document: 'Passed', faceMatch: 'Passed', liveness: 'Passed', age: 'Passed' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      provider: 'Yoti',
      method: 'Government ID + Selfie',
      reference: 'VRF-2026-0402-MO18',
      attempts: 3,
      checks: { document: 'Passed', faceMatch: 'Failed', liveness: 'Passed', age: 'Not Provided' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      method: 'Government ID + Selfie',
      ageRequirement: '18+ confirmed',
      verifiedAt: 'Jan 26, 2024 · 09:05',
      reference: 'VRF-2024-0126-PS77',
      attempts: 2,
      checks: { document: 'Passed', faceMatch: 'Passed', liveness: 'Passed', age: 'Passed' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      provider: 'Yoti',
      method: 'Government ID + Selfie',
      reference: 'VRF-2026-0412-TS93',
      attempts: 1,
      checks: { document: 'Passed', faceMatch: 'Not Provided', liveness: 'Not Provided' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      method: 'Government ID + Selfie',
      ageRequirement: '18+ confirmed',
      verifiedAt: 'Nov 09, 2023 · 18:47',
      reference: 'VRF-2023-1109-AT52',
      attempts: 1,
      checks: { document: 'Passed', faceMatch: 'Passed', liveness: 'Passed', age: 'Passed' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      method: 'Government ID + Selfie',
      ageRequirement: '18+ confirmed',
      verifiedAt: 'Oct 14, 2023 · 11:20',
      reference: 'VRF-2023-1014-LO66',
      attempts: 1,
      checks: { document: 'Passed', faceMatch: 'Passed', liveness: 'Passed', age: 'Passed' },
    },
  ...
  },
  {
    ...
    verification: {
      ...
      method: 'Government ID + Selfie',
      ageRequirement: '18+ confirmed',
      verifiedAt: 'Aug 21, 2023 · 08:12',
      reference: 'VRF-2023-0821-DK30',
      attempts: 1,
      checks: { document: 'Passed', faceMatch: 'Passed', liveness: 'Passed', age: 'Passed' },
    },
